...
out_dir = "/kaggle/working/station_AI_loss_ec/"
...
########################
    ...
    train_loader = DataLoader(
        ...
        generator=g, worker_init_fn=_worker_init_fn, num_workers=0,pin_memory=pin, drop_last=True
    )
    val_loader = DataLoader(
        ...
        batch_size=32, shuffle=False, num_workers=0,pin_memory=pin, drop_last=True
    )
    ...
    for epoch in range(num_epochs):
        ...
        for hist_b, nwp_b, coord_b, y_b in train_loader:
            ...
            weights = torch.tensor(
             [1.0, 1.0, 1.0, 1.0, 8, 12.4, 14.2, 16.5, 17.8, 18.0],device=y_true_phys.device,dtype=y_true_phys.dtype)
